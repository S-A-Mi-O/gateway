...
class SuperAdminCreationInterceptorTest {
    ...
    private lateinit var interceptor: com.samio.gateway.config.web.SuperAdminCreationInterceptor

    @BeforeEach
    fun setUp() {
        userRestService = mock(_UserRestService::class.java)
        jwtUtil = mock(JwtUtil::class.java)
        interceptor = com.samio.gateway.config.web.SuperAdminCreationInterceptor(userRestService, jwtUtil)
    }
